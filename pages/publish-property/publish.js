document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const apartmentResponse = await fetch('https://backendhospedaya.onrender.com/api/apartment', {
                method: 'POST',
            ...
            if (selectedFiles.length > 0) {
                for (let file of selectedFiles) {
                    ...
                    const photoResponse = await fetch(`https://backendhospedaya.onrender.com/api/apartment/${apartmentId}/photo`, {
                        method: 'POST',
                        body: formData
                    });
