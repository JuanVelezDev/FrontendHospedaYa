...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadApartments() {
        try {
            const response = await fetch("https://backendhospedaya.onrender.com/api/apartment");
    ...
    async function loadApartmentPhotos(apartmentId, imgElement) {
        try {
            const response = await fetch(`https://backendhospedaya.onrender.com/api/apartment/${apartmentId}/photos`);
